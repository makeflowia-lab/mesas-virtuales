...
export function AIInputWithFile({
  ...
  placeholder = "Sube un archivo y envía un mensaje",
  minHeight = 52,
  maxHeight = 200,
  accept = "image/*",
  maxFileSize = 5,
  ...
  const { fileName, fileInputRef, handleFileSelect, clearFile, selectedFile, error } = useFileInput({ accept, maxSize: maxFileSize })
...
export const AIInputWithFileDemo = () => {
